...
public class HomePageAdapter extends RecyclerView.Adapter {
        ...
        private void setBannerSliderViewPager(final List<SliderModel> sliderModelList) {
            ...
            ViewPager.OnPageChangeListener onPageChangeListener = new ViewPager.OnPageChangeListener() {
                ...
                public void onPageScrollStateChanged(int i) {
                    if (i == bannerSliderViewPager.SCROLL_STATE_IDLE) {
    ...
    public class HorizontalProductViewHolder extends RecyclerView.ViewHolder{
        ...
        private void setHorizontalProductLayout(List<HorizontalProductScrollModel> horizontalProductScrollModelList,String title){
            ...
            HorizontalPetScrollAdapter horizontalPetScrollAdapter = new HorizontalPetScrollAdapter(horizontalProductScrollModelList);
            LinearLayoutManager linearLayoutManager = new LinearLayoutManager(itemView.getContext());
            linearLayoutManager.setOrientation(LinearLayoutManager.HORIZONTAL);
            horizontalRecyclerView.setLayoutManager(linearLayoutManager);

            horizontalRecyclerView.setAdapter(horizontalPetScrollAdapter);
            horizontalPetScrollAdapter.notifyDataSetChanged();
        }
    }
    ...
    public class GridProductViewHolder extends RecyclerView.ViewHolder{
        ...
        public GridProductViewHolder(@NonNull View itemView) {
            super(itemView);
             ...
             gridView = itemView.findViewById(R.id.grid_product_layout_griview);
        }
